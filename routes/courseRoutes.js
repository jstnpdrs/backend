...
router.route('/:course').get(getCourse).delete(deleteCourse).patch(updateCourse)
router.route('/:course/students').get(getStudents).post(addStudent)
router.route('/:course/students/:student').patch(updateStudent).delete(deleteStudent)
